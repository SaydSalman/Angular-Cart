  ...
  this.payPalConfig = {
      ...
      onClientAuthorization: (data) => {
          ...
          this.api.emptyCartAPI().subscribe((res:any)=>{
            ...
            this.toastr.success("Successfully Placed Your Order... Thank You For Your Purchase")
      ...
      onCancel: (data, actions) => {
          ...
          this.toastr.warning( "You have cancelled the payment");
         this.checkoutStatus=false;

      },
      onError: err => {
          console.log('OnError', err);
          this.toastr.warning("Transaction failed... please try after sometime")
      },
